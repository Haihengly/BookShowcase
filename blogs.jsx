...
const Blogs = () => {
    const Data =[
        { img : pic1, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'},
        { img : pic2, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'},
        { img : pic3, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'},
        { img : pic4, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'},
        { img : pic5, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'},
        { img : pic6, Title : 'Blog Title Goes Here', Des : 'Blog Descrioption Gose Here'}
    ]
    return (
                ...
                <div className="w-full h-[80%] px-28 pt-14">
                    <div className="w-full h-[7%] flex">
                        ...
                        <div className="w-[10%] h-full flex justify-center items-center border-2 border-black">
                            <h1 className="font-serif text-xl font-medium text-black">Our Blogs</h1>
                        </div>
                        <div className="w-[45%] h-[50%] border-b-2 border-black" />
                    </div>
                        ...
                        <div className='h-[70%] w-[100%] overflow-x-auto flex scrollbar-hide'>
                            {
                                Data.map((data, index) => {
                                    return (
                                        <div className='w-[30%] h-full flex-shrink-0 border-2 border-black ml-10 hover:border-white hover:shadow-white' key={index}>
                                            <div className='w-[100%] h-[65%]'>
                                                <img src={data.img} alt="" className='w-full h-full object-cover' />
                                            </div>
                                            
                                            <div className='w-full h-[35%] py-3 '>
                                                <h1 className='text-left text-3xl font-mono text-black font-medium ml-4'>{data.Title}</h1>
                                                <h1 className='text-left text-xl font-mono text-black font-medium ml-4 py-2'>{data.Des}</h1>
                                            </div>
                                        </div>
                                    )
                                })
